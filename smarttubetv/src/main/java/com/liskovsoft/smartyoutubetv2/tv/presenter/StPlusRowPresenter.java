...
public class StPlusRowPresenter extends CustomListRowPresenter {
    ...
    private boolean isOurRow(RowPresenter.ViewHolder holder, Object item) {
        ...
        // Tytul bierzemy z StPlus, a nie z zasobow — nasze teksty maja wlasny
        // przelacznik jezyka (StPlusText), wiec zasob nie musi sie z nimi zgadzac.
        return StPlus.rowTitleText().equals(row.getHeaderItem().getName());
    }
